...
import { ArrowLeft, Clock3, Crown, Film, LockKeyhole, UserRound } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb] text-[#172033] [font-family:'Avenir_Next',Avenir,'Segoe_UI',ui-sans-serif,system-ui,sans-serif]">
      <div className="mx-auto max-w-[1510px] px-5 py-7 sm:px-8 lg:px-10 lg:py-9">
        <Link href="/library" className="mb-6 inline-flex items-center gap-2 text-sm font-semibold text-[#687486] transition hover:text-[#ed6049]"><ArrowLeft className="size-4" aria-hidden="true" /> Back to library</Link>
