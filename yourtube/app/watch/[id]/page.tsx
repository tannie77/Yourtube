        ...
        {state === "ready" && video && (
          <div className={`grid items-start gap-8 ${theatreMode ? "lg:grid-cols-1" : "lg:grid-cols-[minmax(0,1fr)_310px]"}`}>
            <div className="min-w-0 space-y-6">
              {video.canWatch ? <Videoplayer key={video._id} video={video} nextVideo={related.find((item) => item.canWatch)} onLoaded={refreshUsage} theatreMode={theatreMode} onTheatreChange={setTheatreMode} /> : (
